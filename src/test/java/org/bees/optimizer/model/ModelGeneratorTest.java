...
public class ModelGeneratorTest {
    ...
    public void validatePointsGenerator() {
        ...
        Assert.assertEquals(500, pointsDto.getPoints().size());
        ...
        pointsDto.getPoints()
                 .forEach(pointDto -> {
                     ...
                     p.add(pointDto.getIndex());
                 });
        IntStream.range(0, 500).forEach(i -> Assert.assertTrue(p.contains(i)));
    }
    ...
    public void validateRoutesGenerator() {
        ...
        Assert.assertEquals(500 * 499 / 2, routesDto.getRoutes().size());
